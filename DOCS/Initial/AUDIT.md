...
| AUD-57 | Open, planned | Every gap has a v3.2 fix in the plan. It closes when 7.6, 9.1's perceptual springs, 73.5, 88.4, 89.4, 90.4–90.6, 91.2 and the 91.7 composition suite pass their gates, and when the Law 17 label check is green in CI. |
