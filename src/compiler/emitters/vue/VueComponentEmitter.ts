...
export class VueComponentEmitter {
  ...
  public static emit(
    ...
    switch (element.archetype) {
      ...
      case "badge": {
        const label = (get("content.label") as string) || "Active";
      ...
      case "image": {
        ...
        const alt = (get("media.alt") as string) || "Media image";
      ...
      case "divider": {
        const orientation = (get("divider.orientation") as string) || "horizontal";
      ...
      case "text": {
        const text = (get("content.text") as string) || (get("content.label") as string) || "Heading Text";
